...
from archimedes import client  # 导入harpc 的client
from archimedes.common import config # 导入harpc 配置库
...
if __name__ == '__main__':
    ...
    # conf.set("client", "zk_connect_str", "172.0.0.1:2181") # zk 连接地址
